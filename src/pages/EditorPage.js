...
const EditorPage = () => {
    ...
    function runCode() {
        ...
        try {
            ...
            setOutput(outputString || "No output");
        } catch (err) {
    ...
    return (
        <div className="mainWrap">
            <div className="aside">
                ...
                <button className="btn runBtn" style={{ marginBottom:'10px' }} onClick={runCode}>
                    Run Code
                </button>
                <button
                    className="saveCodeFeature"
            ...
            <div className="output-section px-4 my-3" style={{ width: '1900px' }}>
                <h5 className="text-success">OUTPUT:</h5>
